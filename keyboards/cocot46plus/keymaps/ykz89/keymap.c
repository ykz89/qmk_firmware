...
#define LAYOUT_LAYER_BASE                                                                     \
       ...
       KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    KC_K,    KC_H, KC_COMM,  KC_DOT, KC_SLSH, \
                      ESC_MED, SPC_NAV, TAB_FUN, ENT_SYM, BSP_NUM, DEL_MED
...
#define LAYOUT_LAYER_MEDIA                                                                    \
    RGB_VAI, RGB_SAI, RGB_HUI, RGB_MOD, RGB_TOG, RGB_TOG,RGB_RMOD, RGB_HUI, RGB_SAI, RGB_VAI, \
...
#define LAYOUT_LAYER_POINTER                                                                  \
    XXXXXXX, XXXXXXX, ROT_MOD, DPI_MOD, S_D_MOD, S_D_MOD, DPI_MOD, ROT_MOD, XXXXXXX, XXXXXXX, \
...
LAYOUT( \
    ...
    KC_LCTL,    L20,    L21,    L22,    L23,    L24,    R25,    R26,    R27,    R28,    R29,    KC_RSHIFT,  \
                CAPSWRD,L30,    L31,    L32,KC_BTN1,KC_BTN2,    R33,    R34,    R35,XXXXXXX,                                 \
                                        KC_PGUP,KC_BTN3,KC_PGDN,XXXXXXX,XXXXXXX,XXXXXXX                                              \
)

#define LAYOUT_wrapper(...) _LAYOUT_3x5_TO_3x6(__VA_ARGS__)
        ...
        #    endif // CHARYBDIS_AUTO_SNIPING_ON_LAYER
            ...
            switch (get_highest_layer(state)) {
                ...
                case LAYER_POINTER:
                    ...
                    break;
                case LAYER_NUMERAL:
                    rgblight_sethsv_range(HSV_PINK, 0, 2);
                    break;
                case LAYER_SYMBOLS:
                    rgblight_sethsv_range(HSV_ORANGE, 0, 2);
                    break;
                default:
                    rgblight_sethsv_range( rgblight_get_hue(), rgblight_get_sat(), rgblight_get_val(), 0, 2);
                    break;
            }
